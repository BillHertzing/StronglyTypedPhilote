  ...
  public partial class StronglyTypedIDSerializationUnitTests001 : IClassFixture<SerializationFixture> {
    ...
    public void GuidIdDeserializeFromJSON(GuidStronglyTypedIdSerializationTestData inStronglyTypedIdTestData) {
      if (String.IsNullOrEmpty(inStronglyTypedIdTestData.SerializedStronglyTypedId)) {
        ...
        //SerializationFixture.Serializer.Deserialize<GuidStronglyTypedId>(inStronglyTypedIdTestData.SerializedStronglyTypedId).Should().BeEquivalentTo(inStronglyTypedIdTestData.StronglyTypedId);
