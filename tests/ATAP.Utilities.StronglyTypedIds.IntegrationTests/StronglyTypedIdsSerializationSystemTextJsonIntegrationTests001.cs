...
namespace ATAP.Utilities.StronglyTypedIds.IntegrationTests {
  ...
  public partial class StronglyTypedIdSerializationSystemTextJsonUnitTests001 : IClassFixture<SerializationSystemTextJsonFixture> {
    protected SerializationSystemTextJsonFixture SerializationFixture { get; }
    protected ITestOutputHelper TestOutput { get; }
    public StronglyTypedIdSerializationSystemTextJsonUnitTests001(ITestOutputHelper testOutput, SerializationSystemTextJsonFixture serializationFixture) {
      ...
      // Add Converters, but only once
      // ToDo: figure out if the specific factory is in the collection, instead of just any
      if ( SerializationFixture.JsonSerializerOptions.Converters.Count == 0) {
        SerializationFixture.JsonSerializerOptions.Converters.Add(new ATAP.Utilities.StronglyTypedIds.JsonConverter.Shim.SystemTextJson.StronglyTypedIdJsonConverterFactory());
      }
    }
