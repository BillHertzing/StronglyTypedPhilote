...
namespace ATAP.Utilities.StronglyTypedIds.UnitTests {
  ...
  public class StronglyTypedIdInterfaceSerializationTestData<TValue> where TValue : notnull {
    ...
    public StronglyTypedIdInterfaceSerializationTestData(IAbstractStronglyTypedId<TValue> instanceTestData, string serializedTestData) {
    ...
    public static IEnumerable<object[]> StronglyTypedIdSerializationTestData() {
      switch (typeof(TValue)) {
        case Type guidType when typeof(TValue) == typeof(Guid): {
            yield return new StronglyTypedIdInterfaceSerializationTestData<TValue>[] { new StronglyTypedIdInterfaceSerializationTestData<TValue> { InstanceTestData = (IAbstractStronglyTypedId<TValue>)new GuidStronglyTypedId(Guid.Empty), SerializedTestData = "\"00000000-0000-0000-0000-000000000000\"" } };
            yield return new StronglyTypedIdInterfaceSerializationTestData<TValue>[] { new StronglyTypedIdInterfaceSerializationTestData<TValue> { InstanceTestData = (IAbstractStronglyTypedId<TValue>)new GuidStronglyTypedId(new Guid("01234567-abcd-9876-cdef-456789abcdef")), SerializedTestData = "\"01234567-abcd-9876-cdef-456789abcdef\"" } };
            yield return new StronglyTypedIdInterfaceSerializationTestData<TValue>[] { new StronglyTypedIdInterfaceSerializationTestData<TValue> { InstanceTestData = (IAbstractStronglyTypedId<TValue>)new GuidStronglyTypedId(Guid.NewGuid()), SerializedTestData = "" } };
          }
          break;
        case Type intType when typeof(TValue) == typeof(int): {
            yield return new StronglyTypedIdInterfaceSerializationTestData<TValue>[] { new StronglyTypedIdInterfaceSerializationTestData<TValue> { InstanceTestData = (IAbstractStronglyTypedId<TValue>)new IntStronglyTypedId(0), SerializedTestData = "0" } };
            yield return new StronglyTypedIdInterfaceSerializationTestData<TValue>[] { new StronglyTypedIdInterfaceSerializationTestData<TValue> { InstanceTestData = (IAbstractStronglyTypedId<TValue>)new IntStronglyTypedId(1234567), SerializedTestData = "1234567" } };
            yield return new StronglyTypedIdInterfaceSerializationTestData<TValue>[] { new StronglyTypedIdInterfaceSerializationTestData<TValue> { InstanceTestData = (IAbstractStronglyTypedId<TValue>)new IntStronglyTypedId(new Random().Next()), SerializedTestData = "" } };
          }
          break;
