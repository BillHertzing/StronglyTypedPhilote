...
namespace ATAP.Utilities.Philote {
  public static class InstanceFactory {
    ...
    private static ConcurrentDictionary<Tuple<Type, Type, Type, Type>, CreateDelegate> cachedFunctions = new ConcurrentDictionary<Tuple<Type, Type, Type, Type>, CreateDelegate>();
  ...
  public static class InstanceFactoryGeneric<TArg1, TArg2, TArg3> {
    private static ConcurrentDictionary<Type, Func<TArg1, TArg2, TArg3, object>> cachedFunctions = new ConcurrentDictionary<Type, Func<TArg1, TArg2, TArg3, object>>();

    public static object CreateInstance(Type type, TArg1 arg1, TArg2 arg2, TArg3 arg3) {
      if (cachedFunctions.TryGetValue(type, out Func<TArg1, TArg2, TArg3, object> func)) {
    ...
    private static Func<TArg1, TArg2, TArg3, object> CacheFunc(Type type, TArg1 arg1, TArg2 arg2, TArg3 arg3) {
      ...
      var func = lambdaExpr.Compile();
      cachedFunctions.TryAdd(type, func);
      return func;
    }
  }
